...
Accounting treatment: The insurer is to use the accounting standard ordinarily used for statutory reporting so that the pre-stress/scenario EBS capital and surplus can be reconciled to the insurer's 2025 year-end economic balance sheet.
...
Balance sheet date: The insurer is to run the stress/scenario tests based on its balance sheet position and aggregate in-force exposures as at 1 January $2026{ }^{2}$.
...
The Scenario-Based Approach liabilities should be revalued reflecting the stressed asset values. The spread stress in scenarios R4 and R5 is applied as an instantaneous shock applicable during the first year in the projection. The shock is assumed to be temporary in nature; accordingly, the spreads are assumed to revert to their base (non-stressed) levels after the first year in the SBA projection. To the extent that, because of the stress in scenarios R1, R2 or R5, there are not enough SBA-eligible assets to use the SBA for the whole business, then the Standard Approach will need to be used for the rest of the business. However, it is important to ensure that there is "no splitting of liabilities" at policyholder contract level and block-product level. To the extent that the no splitting of liabilities condition cannot be achieved, the standard approach should be applied to the entire business. Where any portion of the liabilities typically use the SBA uses the Standard Approach in a stress, this should be identified in the report submitted as an attachment to the BSCR.
...
R3. Yield This stress refers to moderate and severe movements in global yields. The (re)insurer will apply the Curve following absolute stresses to the yield curves used for the valuation of assets and liabilities. The stress Stress will apply to all yield curves used (explicitly or implicitly) in those valuations, including (but not limited to) the published risk-free or standard curves, curves used in the SBA calculation, any other curve used for Discount Cash Flows (DCF)-style calculations and yields used to predict policyholder behaviour. Asset values should be revalued assuming constant credit spreads. The resulting yields should not be floored at zero in any of the scenarios.
...
R4. General Credit spreads widen across different rating classes (see Table 2). The widening reflects the increase widening of of the perceived credit risk in the market. The table summarises the shocks.

credit
spreads

| Table 2. Credit Spread Widening In basis points |  |  |  |  |  |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Rating Category |  |  |  |  |  |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
|  | <1 year | << years | Time to Maturity <5 years | <7 years | >7 years |
...
[^1]R8. Inflation Inflation risk reflects the unexpected change in prices.
and Monetary Higher than expected inflation may increase the value of indemnities, claims and expenses such Policy Risk as salaries, where these are not contractually fixed. Simulate a scenario similar to the 2025 inflationary scenario.
...
| Scenario | Change in inflation rate (Y1) | Change in inflation rate (Y2) | Change in inflation rate (Y3) | Change in inflation and interest rate (Y4) |
| :--- | :--- | :--- | :--- | :--- |
| Moderate Inflation | +5.0\% | +5.0\% | +5.0\% | +5.0\% |
...
R9. Long Term Liquidity Stress Scenario
...
| :--- | :--- |
| Tier 1 Certificates of Deposit | Should be withdrawable within 48 hours without economic penalties |
| Tier 2 Certificates of Deposit | Should be withdrawable within 7 days without economic penalties |
| Tier 3 Certificates of Deposit | Certificates of Deposit not falling within Tier 1 or Tier 2 |
| Undrawn Committed Lines | Qualifying Committed Lines for this section shall refer to lines of credit from 3rd parties that are contractually binding and directly accessible to the licensed (re)insurance entity. The third party must not be able to cancel these lines of credit at their discretion without at least 3 months' prior notice to the Company. The amount shall be adjusted to reflect any such facilities that may have given a cancellation notice and possibility of the Company breaching any covenants upon which these lines depend. Undrawn committed lines is the total committed lines less the amount that has been drawn. |
| Qualified Tier 1 Liquid Mutual and MMFs | Contain cash \& cash equivalents, sovereigns A- or better, max 20\% IG PSE, and max 10\% of any of: IG Covered Bonds, BBB Sovereigns, BBB PSE, IG Corporates, GSE A- or better - all withdrawable within 48 hours with no penalty or deductions |
| Qualified Tier 2 Liquid Mutual and MMFs | Contain cash \& cash equivalents, Tier 1 mutual fund and MMFs with withdrawal period of up to 7 days, max $50 \%$ IG Corporates, up to $20 \%$ of IG PSE and 10\% of IG GSE or IG Covered Bonds - all |


|  | withdrawable within 7 days without any penalties or deductions |
| :--- | :--- |
| Qualified Tier 3 Liquid Mutual and MMFs | Should only contain cash \& cash equivalents, mutual funds that would ordinarily be Tier 1 except for longer withdrawal notice of 30 days, publicly traded equity, IG corporates, IG GSE, IG PSE or IG Covered Bonds - all withdrawable in less than 30 days |
| Investment Funds: Liquid ETFs | ETF is a type of pooled investment security traded in an exchange whose price changes during the day as trading activity takes place. An assessment of the liquidity of an ETF is expected to be performed by the registrant as part of ongoing risk management/ investment processes. |
| All Other Potential on Balance Sheet Liquidity Sources | Please include the remaining assets that are part of the economic balance sheet. i.e., off balance sheet sources of liquidity are to be excluded. |
...
[^0]:    ${ }^{1}$ In this document, the terms 'insurer' and 'insurers' include 'reinsurer' and 'reinsurers,' respectively.
    ${ }^{2}$ Where the fiscal year does not correspond to the calendar year, in-force exposures on the day following the fiscal year-end should be used rather than 1 January 2026.

[^1]:    Source BMA staff calculations and Bloomberg. The haircuts are based on the realization of a prolonged pan-European banking crisis in Europe which will cause sovereign defaults.
