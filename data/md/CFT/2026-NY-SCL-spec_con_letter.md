...
## Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues
...
Please note that December 31, 2026 is the formal date upon which the appointed actuary's opinion should be based. Thus, the asset adequacy testing should use data and assumptions required under this Letter (e.g., net spread limit, equity drop and recovery) as of December 31, 2026. As a modeling convenience, the asset adequacy analysis may use data and assumptions as of an alternative date as early as September 30, 2026 with the results adjusted to reflect any changes in asset and liability composition, behavioral assumptions, market conditions and other relevant factors through 12/31/2026. In such case, the results as of an earlier date adjusted to 12/31 must be provided by March 1, 2027 with results based on data and assumptions as of 12/31/2026 provided by June 1, 2027. If 9/30 data is used initially and results are found not to reflect an acceptable process to true up to 12/31, then the use of an earlier testing date will no longer be permitted. This will require the insurer to provide the actual 12/31 results based on the 12/31 testing date by March 1st for future filings.

Please see Item 4, Item 14(c), and the Special Sensitivity Tests section of this Letter for references to the interest rates scenarios.
...
To reduce the need for follow-up correspondence, a complete summary of applicable actuarial opinions and certifications should be received via Email by the March $1{ }^{\text {st }}$ filing deadline. See AOM and RBC Checklist. Life RBC C3 Phase I and Phase II analyses should be forwarded by June 15, 2027, along with the appointed actuary's certification and documentation consistent with ASOP 41 relating to Actuarial Communications. The documentation of Life RBC C3 Phase I and Phase II analyses should be at least as thorough as those provided in the Actuarial Memorandum per Section 95.9 of Regulation 126. The Life RBC C3 Phase I and Phase II documentation should be submitted either on a fully standalone basis or may include references to the VM-31 Report with any differences between RBC C3 and the reserves identified within a separate section of the RBC Memorandum.

Per Section 95.10(a)(2) of Regulation 126, prior written approval is required to aggregate the results of asset adequacy analysis across lines of business. Aggregation requests should be sent via email to the Albany Life Bureau. When requesting aggregation please include the following information:
...
(8) confirmation that the degree of conservatism in the adequacy testing complies with the NY special considerations letter for 12/31/26 reserves;
...
In addition, a Regulatory Asset Adequacy Issues Summary (RAAIS) should be submitted no later than April 1, 2027. The RAAIS should be consistent with that prescribed in Section 3.B of VM-30 of the NAIC Valuation Manual with the summary being based on the analysis done for the New York submission.
...
The actuarial memorandum per §95.9 of Regulation 126 should include a separate section that specifically addresses each of the fifteen items enumerated below. References can be made to other sections of the actuarial memorandum as appropriate; however, the separate section should contain all specifically requested data, test results, and related explanations.

## (1) Description of Assumptions per § 95.9(b)(1)(vi)

The actuarial memorandum should include appropriate validation of key assumptions to recent actual experience and include justification whenever assumptions used in the asset adequacy analysis are materially different from recent actual experience, particularly when such differences produce more

## New York State Department of Financial Services <br> Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues

favorable testing results. Please also see Section 14(a) and Appendix I for additional guidance. In any event, the appointed actuary should ensure that the "moderately adverse conditions" testing requirement has been satisfied.
...
- For variable annuity with guaranteed business, provide the assumed lapse percentage for combinations of in-the-moneyness and duration. For this purpose, the definition of "in-the-moneyness" is the present value of benefits less the cash surrender value. Any programs that encourage surrender of living benefits or death benefits where the surrender value is in excess of the contractual cash value should not be counted as a lapse.
...
An explanation should be included within the actuarial memorandum for any inconsistencies between the asset allocations in the modeling with actual company practice or the manner in which investment income is allocated by line of business for annual statement reporting purposes. In addition, please explain whether or not the Company is required to have an approved asset segmentation plan on file with the Department per Regulation 33. If the Company has an approved plan, please indicate the date it was approved.
...
The asset adequacy analysis should assume a return on investment for general account assets having substantial volatility of returns (e.g., common stock, real estate, hybrids with significant common stock characteristics, foreign currency risks, Schedule BA assets, private equity) of an immediate 20\% drop in value, followed by a 5.5\% annual return (before deduction of investment expenses) starting at the beginning of the second projection year. Such drop and recovery shall not apply to any fixed income asset

## New York State Department of Financial Services <br> Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues

reported at amortized cost. The memorandum should clarify which assets were subject to this drop and recovery and which were not, and provide the annual statement carrying value for each major asset category. This drop and recovery should be performed if assets with substantial volatility of returns are supporting general account liabilities. In addition, if assets having substantial volatility of returns are assumed to be purchased in the future, the asset should be assumed to follow the same 20\% drop and $5.5 \%$ recovery pattern as stated above, starting at the date of purchase of the asset. Private equity should be treated the same as common stock.

The actuarial memorandum must include disclosures on how the market value of private equity, private credit, and other illiquid assets have been determined, including but not necessarily limited to: who determines the prices; what sources of data or reference markets are used; how frequently the prices are updated; the last time they were updated; how the prices have changed over the last year and how that compares to the change in prices for similar public assets. The actuarial memorandum must also disclose how transaction costs, including bid-ask spreads, have been reflected for sales and purchases.

For any asset where a reasonable estimate of the current market value has not been, or cannot be, determined, the market values used in CFT at time of sale along a scenario should be haircut by an amount reflecting any staleness and/or uncertainty in the valuation or justification must be provided as to why a haircut was not used to determine the relevant market values. An explanation of the methodology used to determine the value of the asset, and the amount of any haircut must be included in the actuarial memorandum.

Similarly, a higher bid-ask spread must be assumed for illiquid assets, or justification must be provided as to why a higher bid-asked spread was not assumed, as compared to those for similar liquid assets, when illiquid assets are sold along a scenario. An explanation of the methodology used to determine the higher bid-ask spread must be included in the actuarial memorandum.

Asset adequacy analysis for all variable annuity and variable life insurance products (including that for any guaranteed living benefits, guaranteed minimum death benefits, and/or recoverability testing of CARVM allowance) should assume the return described above (before deduction of mortality and expense (M\&E) charges and investment expenses) on equity funds and other funds with substantial volatility of returns. A consistent adjustment should be made to expected returns for fixed income funds having equity or other volatile return components (e.g., balanced funds). If projected gains on variable annuities are used to offset projected losses on other business, this drop and recovery must be performed for variable annuity projections in conjunction with the cash flow projections under each interest rate scenario for such other business. This drop and recovery should likewise be performed when aggregating life products held in separate accounts with life products held in the general account.

Anticipated returns for bonds and other fixed income funds should be consistent with the duration and quality of the underlying assets, with due regard for how fund assets might be expected to perform under each interest rate scenario. The assumption used should be discussed in the actuarial memorandum, along with justification that the scenarios used are sufficiently robust to gauge the expected impact of fund volatilities in a manner consistent with the underlying interest scenarios.

Some companies selling variable life or variable annuity products may have made revenue sharing arrangements with the entity responsible for providing investment or other types of services that make payments to the company (or to one of its affiliates). Such payments are typically in exchange for

## New York State Department of Financial Services <br> Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues

administrative services provided by the company (or its affiliate), such as marketing, distribution and recordkeeping. When income attributable to revenue sharing is included in the asset adequacy analysis, the revenue sharing arrangements should be fully explained and justified. In addition, any revenue sharing income that is not contractually guaranteed to the insurer and any successor must be excluded.

The following items need to be included in order to be considered guaranteed:
...
- We do not consider 12b-1 fees as guaranteed.
...
The yield curve for the interest rate scenarios should not be normalized; however, additional scenarios may be provided at the discretion of the appointed actuary (e.g., normalized scenarios, inverted yield curve).
...
For purposes of determining the floor rates on the decreasing scenarios (for both the modified and unmodified scenarios), parallel shifts or proportionate shifts may be used, but a consistent set of scenarios should be employed across all lines of business (i.e., do not use parallel shifts for one type of business and proportionate shifts for another).
...
The following is an example of an approach that conforms to the spirit of this request; however, alternative approaches may also be acceptable. In any event, the provisions for default should reflect current market values. Particular attention also should be paid to assets that have been written down so default provisions are reflective of the amount of the write-down.

Example for an existing asset based on 12/31/2025 treasuries and NAIC spreads*
...
| 5-year Treasury | 3.730\% |
| :--- | :--- |
| 7-year Treasury | 3.940\% |
| 6-year Treasury (Interpolated) | 3.835\% |


| Current spread (bps) | 66.410 |
| :--- | :--- |
| Long Term spread (bps) | 101.920 |
| increase per year for 5 years (bps) | 7.102 |


|  | max spread | max net yield | excess yield |
| :--- | :--- | :--- | :--- |
| 12/31/2025 | 66.410 | 4.499\% | 0.903\% |
| 12/31/2026 | 73.512 | 4.570\% | 0.832\% |
| 12/31/2027 | 80.614 | 4.641\% | 0.761\% |
| 12/31/2028 | 87.716 | 4.712\% | 0.690\% |
| 12/31/2029 | 94.818 | 4.783\% | 0.619\% |
| 12/31/2030 and later | 101.920 | 4.854\% | 0.548\% |

*Please note actual calculations and testing must be based on 12/31/2026 data.
(8) Interim Results
...
Note:
If there are any interim shortfalls (i.e., negative book value surplus) in the aggregate for all lines of business tested at any time during the projection period, with the exception of negative results due to the 20\%

## New York State Department of Financial Services <br> Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues

drop for volatile assets held in support of any variable products, then additional reserves must be posted to eliminate the shortfalls as of the valuation date. If there are any interim shortfalls after year two due to the 20\% drop for volatile assets held in support of any variable products, then additional reserves must be posted to eliminate such shortfalls as of the valuation date. Simply relying on future surplus to cover all projected interim shortfalls will not be accepted.
...
The CS should be determined as follows:
...
where C=competitor rate
    CR = credited rate
    SC = surrender charge
    GR = contractual minimum long-term guaranteed interest rate
```
...
Note:
Policies with a market value adjustment (MVA) are exempted from the dynamic lapse formula above. However, the actuarial memorandum should include commentary on the effectiveness and/or limitations of the MVA formula (e.g., caps on MVA, MVA based on treasuries).

For deferred annuities with minimum interest rate guarantees of 3\% or more, the annual lapse rates assumed in asset adequacy testing should be 2\% or less in low interest rate environments within the projection period, unless the company has relevant and credible experience to the contrary.

For universal life policies with secondary guarantees, the annual lapse rate after the tenth policy year should be less than or equal to 1\%, unless a higher assumption is supported by credible and relevant

## New York State Department of Financial Services <br> Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues

experience or if a shock lapse is expected due to a significant premium increase. For this purpose, the term "lapse" refers to both surrenders for value and lapses due to insufficient premiums to keep the policy in force. If relevant and credible experience is available, then see the Special Sensitivity Test section of this Letter.
...
These details should be provided as of 12/31/2026.
...
The appointed actuary should comment on the materiality of these benefits and explain the key benefit variations (e.g., return of principal, rollups, ratchets).

## (11) Variable Annuities with GMDBs and VAGLBs

Standalone asset adequacy analysis results should be provided as of 12/31/2026, even if these benefits have been fully reinsured. Results should be presented as stated in Item 3 above:

- These results should be computed for each of the interest rate scenarios specified in Section 95.10(d)(1)(i), (ii), (iii) and (iv) of Regulation 126 and the modified scenarios described in Item 4 of this Letter in conjunction with three equity scenarios:
...
(iii) 12\% annual return for life of the business

These assumed growth rates for equities should be before deduction of M\&E charges and investment expenses.

The results of such testing may be aggregated with the results for other lines of business as noted in Item 14(c) of this Letter.

- Regarding election and utilization rate assumptions:
    - The following assumptions should be applied in the absence of credible and relevant experience: for all three scenarios, a 100\% election rate should be assumed for GMABs (Guaranteed Minimum Account Balance) at the earliest opportunity where exercising the guaranteed benefit option may be advantageous to the contractholder.
...
In addition, the total option value of VAGLBs along with an explanation of how the option value was calculated should be provided. Such option value should be calculated on a seriatim basis with arbitragefree interest rates and equity return paths with an equity volatility consistent with that currently observed in the market and assuming efficient policyholder behavior. The option value should be provided before and after reinsurance and clearly show the associated reserve and account values.

## (12) Equity Linked Products

For all equity linked products (e.g., equity indexed annuities, buffer annuity products, registered index-linked annuities (RILAs), equity indexed universal life, buffer life products), standalone asset adequacy analysis should be provided as of 12/31/2026, even if these benefits have been fully reinsured. This testing must be performed separately for each product.

## New York State Department of Financial Services <br> Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues

Asset adequacy analysis should follow the guidance (interest rate and equity scenarios) provided in Section (11) above.

In addition, for equity linked annuity products, the analysis should use a 10-year projection period and a projection period long enough for the business to run out. Any additional asset adequacy testing requirement should be determined based on the more conservative of the results from the two projection periods.

The analysis in this section is a requirement. Results may be aggregated pursuant to Section 95.10(a) of Regulation 126.

## (13) Companies with Accelerated Underwriting
...
## (14) Additional Review Criteria for Asset Adequacy Analysis per Regulation 126
...
(a) All material assumptions should be clearly explained and justified in the actuarial memorandum, including validations to historic results and/or industry data as directed in Appendix I.
(b) Each material assumption should include an explicit margin.
(c) Where cash flow testing is performed, the interest rate scenarios specified in Section 95.10(d)(1)(i),
(ii), (iii) and (iv) of Regulation 126 and the modified scenarios 5, 6, and 7 included in Item 4 above should be tested with reserves established such that company aggregate results are positive under each of these scenarios. Aggregation across lines of business (i.e., Health, Life and Annuity) is subject to prior approval per Section 95.10(a)(2) of Regulation 126. Additional reserves needed as a result of required testing under Regulation 147 paragraph 98.9(c)(2)(viii)(j), may not be reduced through aggregation with the results of testing other business.
...
## New York State Department of Financial Services Special Considerations Relating to December 31, 2026 Reserves and Other Solvency Issues

(f) To the extent yield enhancing activity (e.g., securities lending, repurchase agreements) is material to projected cash flows, explain how it is taken into account. Risk free profits may not be assumed in the testing as a result.
...
(I) Any other improvements should not be assumed beyond the valuation date (e.g., mean reversion of the yield curve, increase in spreads, decrease in expenses).
...
(o) Profits from yearly renewable term (YRT) reinsurance (in aggregate at the line of business level - e.g., Life, Annuity and Health) ceded to a reinsurer should not be assumed in the analysis. Appropriate adjustments must be made, and the methodology must be described in the actuarial memorandum.
...
(s) The full amount of admitted negative IMR must be included in the starting assets in asset adequacy testing. The supporting memorandum should confirm, and provide a description of, how the proceeds from fixed income assets were used to buy new, higher yielding fixed income assets and that the proceeds from the sales were not used to pay claims.
(t) Explain how, and by what percentage, the company's Capital \& Surplus (Page 3, Column 1, Line 38) increased as a result of new reinsurance treaties entered into during 2026.

A brief description should be provided for each of these items within the Special Considerations section of the actuarial memorandum.
(15) Review Criteria for "Sound Value" Requirements per Regulation 56
...
1) the actuarial opinion and memorandum as required by §44.11(b)(1)(v) of Regulation 127, and 2) for contracts subject to §44.11(b) of Regulation 127, the Macaulay durations of the assets and of the liabilities.
...
1) the actuarial opinion and memorandum as required by §44.11(c)(2)(v) of Regulation 127, and 2) the Macaulay durations of the assets and of the liabilities (§44.11(c)(2)(iii) of Regulation 127).
...
These tests may suggest the need for additional reserves as deemed appropriate in light of company-specific circumstances.

The results of each of the interest rate scenarios specified in Section 95.10(d)(1)(v), (vi) and (vii) of Regulation 126 must be provided only as a sensitivity test incorporating the prior sections of this Letter (e.g., the net yield pick-up, lapse assumption).
...
In addition, for all companies with VAGLBs, a special sensitivity should be performed using a 40\% immediate drop, 3\% annual recovery starting at beginning of second year.
...
Life RBC Phase 2 stochastic testing should include a special sensitivity test, excluding the impact of hedges not actually held as of the valuation date.
...
## Appendix I - Validation

The following information should be included with the response to the Department's Special Considerations Letter.

1. For the cash-flow tested business, both in aggregate and by modeled groups, provide in a spreadsheet the projected income statement and balance sheet for each year of the projection period for the level interest rate scenario with items including, but not limited to, the following:
    a. Premium
    b. Gross investment income (as opposed to net investment income)
    c. Investment expenses
    d. Default costs
    e. Death benefits
    f. Annuity benefits
    g. Disability benefits
    h. Surrender benefits
    i. Other benefits (specify)
    j. Maintenance expenses
    k. Commission
    I. Change in reserves
    m. Effect of reinsurance
    n. Invested assets
    o. Policy loan amounts (if applicable)
    p. Policy reserves
    q. Investment reserves (IMR \& AVR)

For each modeled group, and in aggregate, corresponding to the projected data above:


i. Provide the initial amount of each balance sheet item.
ii. Explain the rationale for the number of years projected.
iii. Provide both the actual gross and net investment rates of return in 2026 for the initial assets backing the initial reserves.
2. A comparison of prior 3 years' Actual to 2027 Projected for cash-flow components in Item 1 above, and an explanation of any significant difference in terms of dollar amount or rate. For example, while the 2026 actual investment income may differ from the 2027 projected amount, investment rates of return should be comparable. Confirm that the 2026 actual amounts used in the comparison have been reconciled to the company's 2026 Annual Statement.
3. Provide in a spreadsheet:
    i. Amounts of modeled assets and statement assets as of the projection start date, both on a book value basis and on a market value basis, and by asset classes at least as detailed as the asset page of the statutory statement (e.g. bond, stock).
    ii. Amounts of modeled liabilities and statement liabilities as of the projection start date, by major in-force blocks or lines of business.
