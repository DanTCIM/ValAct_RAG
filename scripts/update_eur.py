"""Daily EUR/GBP rate refresh: pull FRED series, write parquet to Cloudflare R2.

Run locally:    python scripts/update_eur.py
Run in CI:      see .github/workflows/update_eur.yml
"""
...
BUCKET = "market-data"
KEY = "eur/rates.parquet"

SERIES_IDS = {
    "EUR €STR":  "ECBESTRVOLWGTTRMDMNRT",
    "GBP SONIA": "IUDSOIA",
    "EUR/USD":   "DEXUSEU",
    "GBP/USD":   "DEXUSUK",
}
